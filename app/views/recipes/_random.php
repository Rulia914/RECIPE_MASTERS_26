<?php
/**@var array $randomRecipe */;?>
<!-- Hero Recipe Card -->

<section class="relative mb-6">
    <img
        class="w-full h-96 object-cover"
        src="<?php echo $randomRecipe['recipePicture']; ?>"
        alt="<?php echo $randomRecipe['recipeName']; ?>" />
    <div
        class="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-gray-900 to-transparent">
        <h1 class="text-3xl font-bold mb-2 text-white">
            <?php echo $randomRecipe['recipeName']; ?>
        </h1>
        ...
        <div class="flex items-center mb-4">
            <span class="text-gray-400 mr-2">Par <?php echo $randomRecipe['userName']; ?></span>
            <span class="text-gray-500"><i class="fas fa-comment"></i> 12 commentaires</span>
        </div>
        <a
        href="?recipes=show&id=<?php echo $randomRecipe['recipeID']; ?>"
