    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <?php foreach ($popularRecipes as $recipe): ?>
            ...
            <article
                ...
                <div class="p-4">
                    <h3 class="text-xl font-bold mb-2"><?php echo $recipe['recipeName']; ?></h3>
                    ...
                    <div class="flex items-center mt-4">
                        <span class="text-gray-700 mr-2">Par <?php echo $recipe['userName']; ?></span>
                        <span class="text-gray-500"><i class="fas fa-comment"></i> 8 commentaires</span>
                    </div>
                    <a
                        href="?recipes=show&id=<?php echo $recipe['recipeID']; ?>"
