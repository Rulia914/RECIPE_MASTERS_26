...
<!--Section des POPULAR RECIPES-->
 <section>
          ...
          <div class="flex items-center mb-6">
            <!-- User Avatar -->
            <img
              src="<?php echo $randomUser['picture'];?>"
            ...
            <div>
              ...
              <p class="text-gray-400"><?php echo $randomUser['created_at'];?></p>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                />
                <div class="p-4">
                  <h5 class="text-lg font-bold mb-2"><?php echo $recipe['name']; ?></h5>
                  <div class="flex items-center mb-2">
                    <span class="text-yellow-500 mr-1"
                      ><i class="fas fa-star"></i
                    ></span>
                  ...
                  <?php echo \Core\Helpers\truncate($recipe['description']); ?>
                  </p>
                  <a
